...
<body>
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  ...
                  <input type="text" name="username" class="form-control form-control-xs " placeholder="username" required autofocus>
                </div>
                <div class="form-group">
  ...
  if (isset($_POST['login'])) {
    ...
    $sql_login = "SELECT * FROM operator WHERE username ='$username' AND password='$password'";
