		...
		<div class="row">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									<label>Jabatan</label>
									<input type="text" name="jabatan" value="<?php echo $jabatan; ?>" class="form-control" placeholder="Jabatan Anda..">
								</div>
								<div class="form-group">
									<label>Program</label>
									<input type="text" name="program" value="<?php echo $program; ?>" class="form-control" placeholder="Program yang ingin Anda ikuti..">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-md-5">
				<div class="card">
					...
					<div class="card-body">
						<div class="row justify-content-md-center">
							<a href="../dataFoto/scan_berkas/<?php echo $berkas; ?>"><?php echo $berkas; ?></a>
							<!-- <iframe src="../dataFoto/scan_berkas/<?php echo $berkas; ?>" width="600" height="400"></iframe> -->
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="row justify-content-md-center">
							<a href="../dataFoto/scan_sp/<?php echo $sp; ?>"><?php echo $sp; ?></a>
							<!-- <iframe src="../dataFoto/scan_sp/<?php echo $sp; ?>" width="600" height="400"></iframe> -->
						</div>
					</div>
				</div>
			</div>
