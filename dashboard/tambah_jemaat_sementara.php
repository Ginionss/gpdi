			...
			<form method="POST">
				<div class="card">
					<div class="card-header">
						<div class="card-title">FORM TAMBAH DATA JEMAAT SEMENTARA</div>
					</div>
					<div class="card-body">
						<div class="row">
					...
					<div class="card-action">
						...
						<a href="?halaman=tampil_jemaat_sementara" class="btn btn-default btn-sm">Batal</a>
					</div>
				</div>
		</div>
		</form>
...
if (isset($_POST['simpan'])) {
	...
	if ($query) {
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=tambah_jemaat_sementara">';
	}
}
?>