...
if (isset($_POST['simpan'])) {
	...
	$sql = "INSERT INTO penyerahan (tanggal_request,nik,nama_ayah,nama_ibu,file_kartu_keluarga,file_akta_kelahiran,status) VALUES ('$tanggal_request','$nik','$nama_ayah','$nama_ibu','$file_kartu_keluarga','$file_akta_kelahiran','1')";
