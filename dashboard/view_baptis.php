		...
		<div class="col-md-12">
            ...
            <div class="card">
					<div class="card-header">
						<div class="card-title">FORM VERIFIKASI PERMOHONAN BAPTIS </div>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_baptis" class="form-control" value="<?= $tanggal_baptis ?>">
								</div>
                                <div class="form-group">
...
if (isset($_POST['ubah'])) {
	...
	nama_pendeta ='$nama_pendeta' WHERE id_baptis=$id_baptis";
	$query = mysqli_query($konek, $sql);

	$sql1 = "UPDATE jemaat SET baptis = '1' WHERE nik = '$nik'";
	...
	if ($query) {
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=view_baptis">';
	}
}
